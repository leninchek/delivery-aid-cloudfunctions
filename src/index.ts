...
export const importUsers = onRequest(
  { cors: ['https://cuentaconmigo.chemachacon.com.mx', 'https://delivery-aid-qa.web.app', 'https://delivery-aid-qa.firebaseapp.com', 'http://localhost:3000'], timeoutSeconds: 540 },
  async (req, res) => {
    if (req.method !== 'POST') {
